...
import { useThemedLayoutContext, ThemedTitle as DefaultTitle, type RefineThemedLayoutSiderProps } from "@refinedev/mui";
      ...
      >
        ...
        >
          ...
          >
            ...
            {!siderCollapsed && (
              <IconButton size="small" onClick={() => setSiderCollapsed(true)} sx={{
                color: "#fff",
                backgroundColor: "#475be8",
                "&:hover": {
                  backgroundColor: "#1e36e8",
            ...
            {siderCollapsed && (
              <IconButton size="small" onClick={() => setSiderCollapsed(false)} sx={{
                color: "#fff",
                backgroundColor: "#475be8",
                "&:hover": {
                  backgroundColor: "#1e36e8",
